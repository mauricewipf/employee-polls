...
function formatQuestion({optionOneText, optionTwoText, author}:
                            { optionOneText: string, optionTwoText: string, author: User }): Question {
    return {
        id: generateUID(),
        timestamp: Date.now(),
        author: author.id,
...
export function _saveQuestion(question: { optionOneText: string, optionTwoText: string, author: User }): Promise<Question> {
...
export function _saveQuestionAnswer({authedUser, qid, answer}:
                                        { authedUser: string, qid: string, answer: "optionOne" | "optionTwo" }) {
    return new Promise((resolve, reject) => {
